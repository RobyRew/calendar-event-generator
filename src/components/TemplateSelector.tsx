    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <Card className="w-full max-w-md">
        ...
        <div className="flex items-center justify-between p-4 border-b border-[rgb(var(--border))]">
          ...
          <button
            onClick={onClose}
            className="p-1 hover:bg-[rgb(var(--accent))] rounded"
          >
        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full px-3 py-2.5 pr-10 bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-lg text-sm focus:ring-2 focus:ring-[rgb(var(--ring))] focus:border-transparent appearance-none cursor-pointer"
              >
          ...
          {selectedTemplate && (
            <div className="p-3 bg-[rgb(var(--accent))] rounded-lg border border-[rgb(var(--border))]">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 text-[rgb(var(--muted-foreground))] hover:text-[rgb(var(--foreground))]"
            >
            ...
            {currentEvent && (
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 text-[rgb(var(--muted-foreground))] hover:text-[rgb(var(--foreground))] ml-auto"
              >
              ...
              <div className="flex items-end gap-2">
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-14 h-9 text-center bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-lg text-lg"
                  >
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-[rgb(var(--card))] border border-[rgb(var(--border))] rounded-lg text-sm"
                    autoFocus
                  />
                </div>
                <Button
        ...
        {/* Footer Actions */}
        <div className="p-4 border-t border-[rgb(var(--border))] bg-[rgb(var(--accent))]/50 flex gap-2">
          {selectedTemplateId ? (
